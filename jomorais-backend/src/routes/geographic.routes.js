 ...
 */
router.post('/provincias', GeographicController.createProvincia);
 ...
 *         description: Província não encontrada
 */
router.put('/provincias/:id', GeographicController.updateProvincia);
 ...
 *     description: Remove uma província do sistema (não pode ter municípios vinculados)
 *     tags: [Dados Geográficos - Províncias]
 *     parameters:
 *       - in: path
 *         name: id
 ...
 *       400:
 *         description: Província possui municípios vinculados
 *       404:
 *         description: Província não encontrada
 */
router.delete('/provincias/:id', GeographicController.deleteProvincia);
 ...
 *     description: Cria um novo município vinculado a uma província
 *     tags: [Dados Geográficos - Municípios]
 *     requestBody:
 *       required: true
 *       content:
 ...
 *         description: Província não encontrada
 */
router.post('/municipios', GeographicController.createMunicipio);
 ...
 *               codigo_Provincia:
 *                 type: integer
 *                 description: Código da província (opcional para mudança)
 *     responses:
 *       200:
 *         description: Município atualizado com sucesso
 *       404:
 *         description: Município ou província não encontrada
 */
router.put('/municipios/:id', GeographicController.updateMunicipio);
 ...
 *     description: Remove um município do sistema (não pode ter comunas vinculadas)
 *     tags: [Dados Geográficos - Municípios]
 *     parameters:
 *       - in: path
 *         name: id
 ...
 *       400:
 *         description: Município possui comunas vinculadas
 *       404:
 *         description: Município não encontrado
 */
router.delete('/municipios/:id', GeographicController.deleteMunicipio);
 ...
 * /api/geographic/comunas:
 *   post:
 *     summary: Criar nova comuna
 *     description: Cria uma nova comuna vinculada a um município
 *     tags: [Dados Geográficos - Comunas]
 *     requestBody:
 *       required: true
 *       content:
 ...
 *     responses:
 *       201:
 *         description: Comuna criada com sucesso
 *       400:
 *         description: Dados inválidos
 *       404:
 *         description: Município não encontrado
 */
router.post('/comunas', GeographicController.createComuna);

/**
 * @swagger
 * /api/geographic/comunas/{id}:
 *   put:
 *     summary: Atualizar comuna
 *     description: Atualiza os dados de uma comuna existente
 *     tags: [Dados Geográficos - Comunas]
 *     parameters:
 *       - in: path
 *         name: id
 ...
 *               codigo_Municipio:
 *                 type: integer
 *                 description: Código do município (opcional para mudança)
 *     responses:
 *       200:
 *         description: Comuna atualizada com sucesso
 *       404:
 *         description: Comuna ou município não encontrado
 */
router.put('/comunas/:id', GeographicController.updateComuna);

/**
 * @swagger
 * /api/geographic/comunas/{id}:
 *   delete:
 *     summary: Excluir comuna
 *     description: Remove uma comuna do sistema (não pode ter alunos vinculados)
 *     tags: [Dados Geográficos - Comunas]
 *     parameters:
 *       - in: path
 *         name: id
 ...
 *     responses:
 *       200:
 *         description: Comuna excluída com sucesso
 *       400:
 *         description: Comuna possui alunos vinculados
 *       404:
 *         description: Comuna não encontrada
 */
router.delete('/comunas/:id', GeographicController.deleteComuna);
