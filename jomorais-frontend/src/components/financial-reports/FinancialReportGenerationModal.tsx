...
interface FinancialReportGenerationModalProps {
  isOpen: boolean
...
export default function FinancialReportGenerationModal({
  isOpen,
  isGenerating,
  ...
  onGeneratePDFReport
}: FinancialReportGenerationModalProps) {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-xl p-6 w-full max-w-md mx-4">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-semibold text-gray-900">Gerar Relatório Financeiro</h3>
          <button
            onClick={onClose}
        ...
        <div className="mb-6">
          <p className="text-gray-600 mb-4">
            Selecione o formato do relatório financeiro que deseja gerar:
          </p>
          ...
          <div className="space-y-3">
            ...
            >
              ...
              <div className="text-left flex-1">
                ...
                <div className="text-sm text-gray-600">Relatório financeiro completo em formato Word</div>
              </div>
              {isGeneratingWord && (
                <div className="text-sm text-green-600">Gerando...</div>
              )}
            </button>
            ...
            >
              ...
              <div className="text-left flex-1">
                ...
                <div className="text-sm text-gray-600">Relatório financeiro completo em formato PDF</div>
              </div>
              {isGeneratingPDF && (
          ...
          <div className="mt-4 p-3 bg-green-50 rounded-lg">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-green-700">
                {isGeneratingWord ? 'Gerando relatório Word...' : 'Gerando relatório PDF...'}
              </span>
            </div>
          </div>
        )}
