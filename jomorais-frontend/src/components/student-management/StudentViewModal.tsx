          ...
          <div className="flex-1 overflow-y-auto p-6">
            ...
            <div className="flex items-center gap-4 p-4 bg-green-50 rounded-lg">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-600">Código: #{fullStudent.codigo}</p>
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <span className="ml-2 text-gray-900 font-medium">
                    {fullStudent.tb_tipo_documento?.designacao || 'N/A'}
                  </span>
                </div>
                <div>
                ...
                <div>
                  ...
                  <span className="ml-2 text-gray-900 font-medium">
                    {formatDate(fullStudent.dataEmissao)}
                  </span>
                </div>
                <div>
                  <span className="text-gray-500">Província de Emissão:</span>
                  <span className="ml-2 text-gray-900 font-medium">
                    {fullStudent.provinciaEmissao || 'N/A'}
                  </span>
                </div>
              </div>
            </div>
