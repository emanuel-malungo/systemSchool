        ...
        <div className="relative bg-white rounded-xl shadow-2xl max-w-md w-full p-6 transform transition-all">
          <div className="flex items-start justify-between mb-5">
            ...
            <button
              onClick={onClose}
              disabled={isDeleting}
              className="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-50 rounded-lg transition-all duration-200 disabled:opacity-50"
            >
              <X className="h-5 w-5" />
            </button>
          </div>
          ...
          <div className="mb-7">
            <p className="text-sm text-gray-700 mb-4">
              Tem certeza que deseja deletar o estudante <strong className="font-semibold text-gray-900">{studentName}</strong> do sistema?
            </p>
            ...
            <div className="bg-red-50/50 border border-red-100 rounded-lg p-4">
              ...
              <ul className="text-sm text-red-700/90 space-y-1.5 ml-3.5 list-disc">
                <li>O estudante será deletado permanentemente</li>
