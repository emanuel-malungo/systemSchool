import { Eye, Edit2, Trash2, ChevronLeft, ChevronRight, BookMarked } from 'lucide-react'
...
interface DisciplineTableProps {
  ...
  onView: (discipline: IDiscipline) => void
        ...
        <table className="min-w-full divide-y divide-gray-200">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {disciplines.map((discipline) => (
              <tr key={discipline.codigo} className="hover:bg-gray-50 transition-colors">
