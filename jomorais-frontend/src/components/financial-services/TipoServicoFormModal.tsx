...
// Mapear status do mock para opções de serviço
const STATUS_OPTIONS = [
  { codigo: 1, designacao: 'Activo', label: 'Activo' },     // NORMAL
  { codigo: 7, designacao: 'Inactivo', label: 'Inactivo' }  // ELIMINADO
]
              ...
              <div>
                ...
                >
                  {STATUS_OPTIONS.map((status) => (
                    <option key={status.codigo} value={status.designacao}>
                      {status.label}
                    </option>
                  ))}
                </select>
