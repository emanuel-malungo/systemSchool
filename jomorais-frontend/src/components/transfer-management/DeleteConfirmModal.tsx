        ...
        <div className="relative bg-white rounded-lg shadow-xl max-w-md w-full p-6">
          ...
          <div className="mb-6">
            <p className="text-gray-700 mb-4">
              Tem certeza que deseja deletar a transferência do aluno <strong>{studentName}</strong>?
            </p>
            <div className="bg-red-50 border border-red-200 rounded-lg p-4">
              ...
              <ul className="mt-2 text-sm text-red-700 space-y-1 ml-4 list-disc">
                <li>Deletar permanentemente o registro de transferência</li>
                <li>Remover o histórico de transferência do aluno</li>
