...
import type { LegacyUser, UserTableProps } from '../../../types/users.types'
...
export default function UserTable({
    ...
    return (
      <div className="bg-white rounded-lg shadow-sm p-8">
        <div className="text-center text-gray-500">
          ...
          <p className="text-sm mt-2">Tente ajustar os filtros ou adicionar um novo usuário</p>
        </div>
      </div>
    )
  }
  ...
  // Buscar o nome do tipo de usuário
  const getUserTypeName = (user: LegacyUser) => {
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full divide-y divide-gray-200">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {users.map((user) => {
              return (
                <tr key={user.codigo} className="hover:bg-gray-50 transition-colors">
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="text-sm font-medium text-gray-900">{user.nome}</div>
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="text-sm text-gray-900">{user.user}</div>
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
