...
const ActivityItem = memo(({ activity }: ActivityItemProps) => {
	...
	return (
		<div className="flex items-start gap-4 p-4 rounded-2xl hover:bg-gray-50 transition-all duration-300 border border-transparent hover:border-gray-100 group">
			<div className={`w-10 h-10 flex items-center justify-center rounded-xl bg-gray-50 text-gray-400 group-hover:shadow-[0_4px_12px_-4px_rgba(0,0,0,0.1)] transition-all duration-300`}>
				<Icon size={18} />
			</div>
