    ...
    return (
      <Container>
        <div className="flex items-center justify-center h-64">
          ...
          <span className="ml-3 text-gray-600">Carregando matrícula...</span>
        </div>
      </Container>
    )
  }
    ...
    return (
      <Container>
        <div className="text-center py-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Matrícula não encontrada</h2>
          <p className="text-gray-600 mb-4">A matrícula que você está tentando editar não existe.</p>
          <Button onClick={() => navigate('/admin/student-management/enrolls')}>
            Voltar para lista
          </Button>
        </div>
      </Container>
      ...
      <div className="space-y-6">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="bg-white rounded-lg shadow p-6 space-y-6">
            <div>
              ...
              <p className="text-sm text-gray-600">
                Atualize o aluno, curso ou status da matrícula
              </p>
            </div>
          ...
          <div className="flex justify-end gap-4">
            ...
            >
              {isSubmitting || isUpdating || updateMatricula.isPending ? (
                <>
