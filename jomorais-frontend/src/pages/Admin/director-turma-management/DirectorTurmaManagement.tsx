...
import DirectorTurmaViewModal from '../../../components/director-turma-management/DirectorTurmaViewModal'
...
export default function DirectorTurmaManagement() {
  ...
  const [selectedDirectorTurma, setSelectedDirectorTurma] = useState<IDiretorTurma | null>(null)
  ...
  const handleViewDirectorTurma = (directorTurma: IDiretorTurma) => {
    setSelectedDirectorTurma(directorTurma)
    ...
    <Container>
      ...
      <div className="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden">
        <DirectorTurmaTable
          ...
          onView={handleViewDirectorTurma}
      ...
      <DirectorTurmaViewModal
        isOpen={isViewModalOpen}
        onClose={() => {
          setIsViewModalOpen(false)
          setSelectedDirectorTurma(null)
        }}
        directorTurma={selectedDirectorTurma}
        onEdit={handleEditDirectorTurma}
      />
